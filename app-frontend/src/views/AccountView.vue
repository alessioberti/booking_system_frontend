<template>
  <div class="box-container lg:max-w-2xl">
    ...
    <div class="grid grid-cols-1 gap-6">
      <form @submit.prevent="showEmailModal()" class="space-y-6">
        <div>
      ...
      <form @submit.prevent="showPasswordModal()" class="space-y-6">
        <div>
  ...
  <div v-if="emailModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
      ...
      <p class="text-standard text-sm mb-4">Sei sicuro di voler modificare la tua email di accesso?</p>
  ...
  <div v-if="passwordModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
      ...
      <p class="text-standard text-sm mb-4">Sei sicuro di voler modificare la tua password?</p>
      <div class="flex justify-end gap-4">
